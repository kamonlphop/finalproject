package comsci.kamonlphop.finalproject.Adapter;
...
import comsci.kamonlphop.finalproject.R;
...
public class AdapterNetwork extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view1 = objLayoutInflater.inflate(R.layout.listview_network, parent, false);
